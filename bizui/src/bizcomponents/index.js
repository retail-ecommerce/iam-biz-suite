...
const ViewMapping = {
  ...
  'com.terapico.iam.userdomain.UserDomain': {name:'userDomain'},
  'com.terapico.iam.userwhitelist.UserWhiteList': {name:'userWhiteList'},
  'com.terapico.iam.secuser.SecUser': {name:'secUser'},
  'com.terapico.iam.secuserblocking.SecUserBlocking': {name:'secUserBlocking'},
  'com.terapico.iam.userapp.UserApp': {name:'userApp'},
  'com.terapico.iam.listaccess.ListAccess': {name:'listAccess'},
  'com.terapico.iam.objectaccess.ObjectAccess': {name:'objectAccess'},
  'com.terapico.iam.loginhistory.LoginHistory': {name:'loginHistory'},
