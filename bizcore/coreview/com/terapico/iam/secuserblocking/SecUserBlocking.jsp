<%@ page import='java.util.*,com.terapico.iam.*,com.terapico.iam.secuserblocking.SecUserBlocking'%>
...
<sky:include page="com/terapico/iam/secuserblocking/SecUserBlocking$Summary.jsp" />
