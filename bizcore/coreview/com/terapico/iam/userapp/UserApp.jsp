<%@ page import='java.util.*,com.terapico.iam.*,com.terapico.iam.userapp.UserApp'%>
...
<sky:include page="com/terapico/iam/userapp/UserApp$Summary.jsp" />
...
<sky:include page="com/terapico/iam/secuser/SecUser$Info.jsp" />
		...
		<div id="listAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/terapico/iam/listaccess/ListAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["objectAccessList"] or ignoreListAccessControl}'>
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/terapico/iam/objectaccess/ObjectAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
