<%@ page import='java.util.*,com.terapico.iam.*,com.terapico.iam.objectaccess.ObjectAccess'%>
...
<sky:include page="com/terapico/iam/objectaccess/ObjectAccess$Summary.jsp" />
...
<sky:include page="com/terapico/iam/userapp/UserApp$Info.jsp" />
