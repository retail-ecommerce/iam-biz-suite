<%@ page import='java.util.*,com.terapico.iam.*,com.terapico.iam.userdomain.UserDomain'%>
...
<sky:include page="com/terapico/iam/userdomain/UserDomain$Summary.jsp" />
		...
		<div id="userWhiteListList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/terapico/iam/userwhitelist/UserWhiteList$List.jsp"
					referName="domain"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["secUserList"] or ignoreListAccessControl}'>
		...
		<div id="secUserList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/terapico/iam/secuser/SecUser$List.jsp"
					referName="domain"/>
		</div>
	</c:if>
