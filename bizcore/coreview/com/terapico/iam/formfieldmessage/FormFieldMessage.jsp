<%@ page import='java.util.*,com.terapico.iam.*,com.terapico.iam.formfieldmessage.FormFieldMessage'%>
...
<sky:include page="com/terapico/iam/formfieldmessage/FormFieldMessage$Summary.jsp" />
...
<sky:include page="com/terapico/iam/genericform/GenericForm$Info.jsp" />
