<%@ page import='java.util.*,com.terapico.iam.*,com.terapico.iam.secuser.SecUser'%>
...
<sky:include page="com/terapico/iam/secuser/SecUser$Summary.jsp" />
...
<sky:include page="com/terapico/iam/userdomain/UserDomain$Info.jsp" />
...
<sky:include page="com/terapico/iam/secuserblocking/SecUserBlocking$Action.jsp" />
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/terapico/iam/userapp/UserApp$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["loginHistoryList"] or ignoreListAccessControl}'>
		...
		<div id="loginHistoryList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/terapico/iam/loginhistory/LoginHistory$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
