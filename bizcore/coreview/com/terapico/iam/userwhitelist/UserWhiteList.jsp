<%@ page import='java.util.*,com.terapico.iam.*,com.terapico.iam.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/terapico/iam/userwhitelist/UserWhiteList$Summary.jsp" />
