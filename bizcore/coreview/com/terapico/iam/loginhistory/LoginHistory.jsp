<%@ page import='java.util.*,com.terapico.iam.*,com.terapico.iam.loginhistory.LoginHistory'%>
...
<sky:include page="com/terapico/iam/loginhistory/LoginHistory$Summary.jsp" />
