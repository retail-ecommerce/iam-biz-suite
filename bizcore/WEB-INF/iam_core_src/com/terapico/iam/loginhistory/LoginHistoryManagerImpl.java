...
public class LoginHistoryManagerImpl extends CustomIamCheckerManager implements LoginHistoryManager {
	...
	protected void throwExceptionWithMessage(String value) throws LoginHistoryManagerException{
 	...
 	protected LoginHistory saveLoginHistory(IamUserContext userContext, LoginHistory loginHistory, String [] tokensExpr) throws Exception{	
 	...
 	protected LoginHistory saveLoginHistoryDetail(IamUserContext userContext, LoginHistory loginHistory) throws Exception{	
 	...
 	public LoginHistory loadLoginHistory(IamUserContext userContext, String loginHistoryId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public LoginHistory searchLoginHistory(IamUserContext userContext, String loginHistoryId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected LoginHistory present(IamUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens) throws Exception {
 	...
 	public LoginHistory loadLoginHistoryDetail(IamUserContext userContext, String loginHistoryId) throws Exception{	
 	...
 	public Object view(IamUserContext userContext, String loginHistoryId) throws Exception{	
 		LoginHistory loginHistory = loadLoginHistory( userContext, loginHistoryId, viewTokens());
 		return present(userContext,loginHistory, allTokens());
		
 	}
 	protected LoginHistory saveLoginHistory(IamUserContext userContext, LoginHistory loginHistory, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getLoginHistoryDAO().save(loginHistory, tokens);
 	}
 	protected LoginHistory loadLoginHistory(IamUserContext userContext, String loginHistoryId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfLoginHistory(loginHistoryId);
		userContext.getChecker().throwExceptionIfHasErrors( LoginHistoryManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(IamUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(IamUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingLoginHistory(IamUserContext userContext,String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public LoginHistory clone(IamUserContext userContext, String fromLoginHistoryId) throws Exception{
	...
	public LoginHistory internalSaveLoginHistory(IamUserContext userContext, LoginHistory loginHistory, Map<String,Object> options) throws Exception 
	{
	...
	public LoginHistory updateLoginHistoryProperty(IamUserContext userContext,String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingLoginHistory(userContext, loginHistoryId, loginHistoryVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(IamUserContext userContext, String loginHistoryId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(IamUserContext userContext, String loginHistoryId, String anotherLogin) throws Exception
 	{
 	...
 	public LoginHistory transferToAnotherSecUserWithLogin(IamUserContext userContext, String loginHistoryId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(IamUserContext userContext, String loginHistoryId, String anotherEmail) throws Exception
 	{
 	...
 	public LoginHistory transferToAnotherSecUserWithEmail(IamUserContext userContext, String loginHistoryId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(IamUserContext userContext, String loginHistoryId, String anotherMobile) throws Exception
 	{
 	...
 	public LoginHistory transferToAnotherSecUserWithMobile(IamUserContext userContext, String loginHistoryId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(IamUserContext userContext, String loginHistoryId, int loginHistoryVersion) throws Exception {
	...
	public LoginHistory forgetByAll(IamUserContext userContext, String loginHistoryId, int loginHistoryVersion) throws Exception {
		return forgetByAllInternal(userContext, loginHistoryId, loginHistoryVersion);		
	}
	protected LoginHistory forgetByAllInternal(IamUserContext userContext,
			String loginHistoryId, int loginHistoryVersion) throws Exception{
