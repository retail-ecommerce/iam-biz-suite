...
import com.terapico.iam.userdomain.CandidateUserDomain;
import com.terapico.iam.secuserblocking.CandidateSecUserBlocking;
...
public class SecUserManagerImpl extends CustomIamCheckerManager implements SecUserManager {
	...
	protected void throwExceptionWithMessage(String value) throws SecUserManagerException{
 	...
 	protected SecUser saveSecUser(IamUserContext userContext, SecUser secUser, String [] tokensExpr) throws Exception{	
 	...
 	protected SecUser saveSecUserDetail(IamUserContext userContext, SecUser secUser) throws Exception{	
 	...
 	public SecUser loadSecUser(IamUserContext userContext, String secUserId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SecUser searchSecUser(IamUserContext userContext, String secUserId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SecUser present(IamUserContext userContext, SecUser secUser, Map<String, Object> tokens) throws Exception {
 	...
 	public SecUser loadSecUserDetail(IamUserContext userContext, String secUserId) throws Exception{	
 		SecUser secUser = loadSecUser( userContext, secUserId, allTokens());
 		return present(userContext,secUser, allTokens());
		
 	}
 	
 	public Object view(IamUserContext userContext, String secUserId) throws Exception{	
 		SecUser secUser = loadSecUser( userContext, secUserId, viewTokens());
 		return present(userContext,secUser, allTokens());
		
 	}
 	protected SecUser saveSecUser(IamUserContext userContext, SecUser secUser, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getSecUserDAO().save(secUser, tokens);
 	}
 	protected SecUser loadSecUser(IamUserContext userContext, String secUserId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfSecUser(secUserId);
		userContext.getChecker().throwExceptionIfHasErrors( SecUserManagerException.class);
	...
	public SecUser loadSecUserWithMobile(IamUserContext userContext, String mobile, Map<String,Object>tokens) throws Exception{	
 	...
 	protected<T extends BaseEntity> void addActions(IamUserContext userContext, SecUser secUser, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(IamUserContext userContext, SecUser secUser, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSecUser(IamUserContext userContext,String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SecUser clone(IamUserContext userContext, String fromSecUserId) throws Exception{
	...
	public SecUser internalSaveSecUser(IamUserContext userContext, SecUser secUser, Map<String,Object> options) throws Exception 
	{
	...
	public SecUser updateSecUserProperty(IamUserContext userContext,String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingSecUser(userContext, secUserId, secUserVersion, property, newValueExpr, tokensExpr);
	...
	private static final String [] STATUS_SEQUENCE={"BLOCKED"};
 	protected String[] getNextCandidateStatus(IamUserContext userContext, String currentStatus) throws Exception{
 	...
 	protected void ensureStatus(IamUserContext userContext, SecUser secUser, String expectedNextStatus) throws Exception{
	...
	protected void checkParamsForTransferingAnotherDomain(IamUserContext userContext, String secUserId, String anotherDomainId) throws Exception
 	{
	...
	public CandidateUserDomain requestCandidateDomain(IamUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherBlocking(IamUserContext userContext, String secUserId, String anotherBlockingId) throws Exception
 	{
 	...
 	public SecUser transferToAnotherBlocking(IamUserContext userContext, String secUserId, String anotherBlockingId) throws Exception
 	{
	...
	public CandidateSecUserBlocking requestCandidateBlocking(IamUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
	...
	public static final String BLOCKED_STATUS = "BLOCKED";
 	protected void checkParamsForBlocking(IamUserContext userContext, String secUserId, String who, String comments
) throws Exception
 	{
 				userContext.getChecker().checkIdOfSecUser(secUserId);
 	...
 	public SecUserForm blockActionForm(IamUserContext userContext, String secUserId) throws Exception
 	{
 	...
 	protected SecUserBlocking createBlocking(IamUserContext userContext, String who, String comments){
 	...
 	protected void checkIfEligibleForBlocking(IamUserContext userContext, SecUser secUser) throws Exception{
...
//--------------------------------------------------------------
 	...
 	protected SecUserBlocking loadSecUserBlocking(IamUserContext userContext, String newBlockingId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected UserDomain loadUserDomain(IamUserContext userContext, String newDomainId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(IamUserContext userContext, String secUserId, int secUserVersion) throws Exception {
	...
	public SecUser forgetByAll(IamUserContext userContext, String secUserId, int secUserVersion) throws Exception {
		return forgetByAllInternal(userContext, secUserId, secUserVersion);		
	}
	protected SecUser forgetByAllInternal(IamUserContext userContext,
			String secUserId, int secUserVersion) throws Exception{
	...
	protected SecUser breakWithUserAppByObjectId(IamUserContext userContext, String secUserId, String objectIdId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingUserApp(IamUserContext userContext, String secUserId, String title, String appIcon, boolean fullAccess, String permission, String objectType, String objectId, String location,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserAppProperties(IamUserContext userContext, String secUserId,String id,String title,String appIcon,boolean fullAccess,String permission,String objectType,String objectId,String location,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateUserAppProperties(IamUserContext userContext, String secUserId, String id,String title,String appIcon,boolean fullAccess,String permission,String objectType,String objectId,String location, String [] tokensExpr) throws Exception
	{	
	...
	protected UserApp createUserApp(IamUserContext userContext, String title, String appIcon, boolean fullAccess, String permission, String objectType, String objectId, String location) throws Exception{
	...
	protected void checkParamsForRemovingUserAppList(IamUserContext userContext, String secUserId, 
	...
	public  SecUser removeUserAppList(IamUserContext userContext, String secUserId, 
			String userAppIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingUserApp(IamUserContext userContext, String secUserId, 
	...
	public  SecUser removeUserApp(IamUserContext userContext, String secUserId, 
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingUserApp(IamUserContext userContext, String secUserId, 
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyUserAppFrom(IamUserContext userContext, String secUserId, 
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserApp(IamUserContext userContext, String secUserId, String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateUserApp(IamUserContext userContext, String secUserId, String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingLoginHistory(IamUserContext userContext, String secUserId, String fromIp, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLoginHistoryProperties(IamUserContext userContext, String secUserId,String id,String fromIp,String description,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateLoginHistoryProperties(IamUserContext userContext, String secUserId, String id,String fromIp,String description, String [] tokensExpr) throws Exception
	{	
	...
	protected LoginHistory createLoginHistory(IamUserContext userContext, String fromIp, String description) throws Exception{
	...
	protected void checkParamsForRemovingLoginHistoryList(IamUserContext userContext, String secUserId, 
	...
	public  SecUser removeLoginHistoryList(IamUserContext userContext, String secUserId, 
			String loginHistoryIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingLoginHistory(IamUserContext userContext, String secUserId, 
	...
	public  SecUser removeLoginHistory(IamUserContext userContext, String secUserId, 
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingLoginHistory(IamUserContext userContext, String secUserId, 
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyLoginHistoryFrom(IamUserContext userContext, String secUserId, 
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLoginHistory(IamUserContext userContext, String secUserId, String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateLoginHistory(IamUserContext userContext, String secUserId, String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
