...
public class FormFieldManagerImpl extends CustomIamCheckerManager implements FormFieldManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormFieldManagerException{
 	...
 	protected FormField saveFormField(IamUserContext userContext, FormField formField, String [] tokensExpr) throws Exception{	
 	...
 	protected FormField saveFormFieldDetail(IamUserContext userContext, FormField formField) throws Exception{	
 	...
 	public FormField loadFormField(IamUserContext userContext, String formFieldId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormField searchFormField(IamUserContext userContext, String formFieldId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormField present(IamUserContext userContext, FormField formField, Map<String, Object> tokens) throws Exception {
 	...
 	public FormField loadFormFieldDetail(IamUserContext userContext, String formFieldId) throws Exception{	
 		FormField formField = loadFormField( userContext, formFieldId, allTokens());
 		return present(userContext,formField, allTokens());
		
 	}
 	
 	public Object view(IamUserContext userContext, String formFieldId) throws Exception{	
 		FormField formField = loadFormField( userContext, formFieldId, viewTokens());
 		return present(userContext,formField, allTokens());
		
 	}
 	protected FormField saveFormField(IamUserContext userContext, FormField formField, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormFieldDAO().save(formField, tokens);
 	}
 	protected FormField loadFormField(IamUserContext userContext, String formFieldId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormField(formFieldId);
		userContext.getChecker().throwExceptionIfHasErrors( FormFieldManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(IamUserContext userContext, FormField formField, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(IamUserContext userContext, FormField formField, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormField(IamUserContext userContext,String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormField clone(IamUserContext userContext, String fromFormFieldId) throws Exception{
	...
	public FormField internalSaveFormField(IamUserContext userContext, FormField formField, Map<String,Object> options) throws Exception 
	{
	...
	public FormField updateFormFieldProperty(IamUserContext userContext,String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormField(userContext, formFieldId, formFieldVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(IamUserContext userContext, String formFieldId, String anotherFormId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(IamUserContext userContext, String formFieldId, int formFieldVersion) throws Exception {
	...
	public FormField forgetByAll(IamUserContext userContext, String formFieldId, int formFieldVersion) throws Exception {
		return forgetByAllInternal(userContext, formFieldId, formFieldVersion);		
	}
	protected FormField forgetByAllInternal(IamUserContext userContext,
			String formFieldId, int formFieldVersion) throws Exception{
