...
public class IamExceptionJsonSerializer extends  JsonSerializer<IamException> {
	...
	@Override
	public void serialize(IamException exception, JsonGenerator jgen,
	...
	protected void writeExceptionMessage(String message, IamException exception,
	...
	protected void writeStartObject(IamException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		jgen.writeStartObject();
		writeClassField(CLASS,exception,jgen,provider);
	}
	
	private static final String MESSAGE_LIST = "messageList";
	protected void writeEndObject(IamException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		
		writeMessageList(MESSAGE_LIST,exception,jgen,provider);
		jgen.writeEndObject();
	}
	protected void writeClassField(String fieldName,IamException exception,
	...
	protected void writeMessageList(String fieldName,IamException exception,
			JsonGenerator jgen, SerializerProvider provider)
			throws IOException, JsonProcessingException {
		if(exception == null){
			return; //do nothing when base entity is null
