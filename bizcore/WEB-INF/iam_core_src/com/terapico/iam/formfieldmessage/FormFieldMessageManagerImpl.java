...
import com.terapico.iam.genericform.CandidateGenericForm;
...
public class FormFieldMessageManagerImpl extends CustomIamCheckerManager implements FormFieldMessageManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormFieldMessageManagerException{
 	...
 	protected FormFieldMessage saveFormFieldMessage(IamUserContext userContext, FormFieldMessage formFieldMessage, String [] tokensExpr) throws Exception{	
 	...
 	protected FormFieldMessage saveFormFieldMessageDetail(IamUserContext userContext, FormFieldMessage formFieldMessage) throws Exception{	
 	...
 	public FormFieldMessage loadFormFieldMessage(IamUserContext userContext, String formFieldMessageId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormFieldMessage searchFormFieldMessage(IamUserContext userContext, String formFieldMessageId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormFieldMessage present(IamUserContext userContext, FormFieldMessage formFieldMessage, Map<String, Object> tokens) throws Exception {
 	...
 	public FormFieldMessage loadFormFieldMessageDetail(IamUserContext userContext, String formFieldMessageId) throws Exception{	
 	...
 	public Object view(IamUserContext userContext, String formFieldMessageId) throws Exception{	
 		FormFieldMessage formFieldMessage = loadFormFieldMessage( userContext, formFieldMessageId, viewTokens());
 		return present(userContext,formFieldMessage, allTokens());
		
 	}
 	protected FormFieldMessage saveFormFieldMessage(IamUserContext userContext, FormFieldMessage formFieldMessage, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormFieldMessageDAO().save(formFieldMessage, tokens);
 	}
 	protected FormFieldMessage loadFormFieldMessage(IamUserContext userContext, String formFieldMessageId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormFieldMessage(formFieldMessageId);
		userContext.getChecker().throwExceptionIfHasErrors( FormFieldMessageManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(IamUserContext userContext, FormFieldMessage formFieldMessage, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(IamUserContext userContext, FormFieldMessage formFieldMessage, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormFieldMessage(IamUserContext userContext,String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormFieldMessage clone(IamUserContext userContext, String fromFormFieldMessageId) throws Exception{
	...
	public FormFieldMessage internalSaveFormFieldMessage(IamUserContext userContext, FormFieldMessage formFieldMessage, Map<String,Object> options) throws Exception 
	{
	...
	public FormFieldMessage updateFormFieldMessageProperty(IamUserContext userContext,String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormFieldMessage(userContext, formFieldMessageId, formFieldMessageVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(IamUserContext userContext, String formFieldMessageId, String anotherFormId) throws Exception
 	{
	...
	public CandidateGenericForm requestCandidateForm(IamUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected GenericForm loadGenericForm(IamUserContext userContext, String newFormId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(IamUserContext userContext, String formFieldMessageId, int formFieldMessageVersion) throws Exception {
	...
	public FormFieldMessage forgetByAll(IamUserContext userContext, String formFieldMessageId, int formFieldMessageVersion) throws Exception {
		return forgetByAllInternal(userContext, formFieldMessageId, formFieldMessageVersion);		
	}
	protected FormFieldMessage forgetByAllInternal(IamUserContext userContext,
			String formFieldMessageId, int formFieldMessageVersion) throws Exception{
