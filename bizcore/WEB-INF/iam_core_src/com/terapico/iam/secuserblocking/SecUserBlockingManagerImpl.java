...
public class SecUserBlockingManagerImpl extends CustomIamCheckerManager implements SecUserBlockingManager {
	...
	protected void throwExceptionWithMessage(String value) throws SecUserBlockingManagerException{
 	...
 	protected SecUserBlocking saveSecUserBlocking(IamUserContext userContext, SecUserBlocking secUserBlocking, String [] tokensExpr) throws Exception{	
 	...
 	protected SecUserBlocking saveSecUserBlockingDetail(IamUserContext userContext, SecUserBlocking secUserBlocking) throws Exception{	
 	...
 	public SecUserBlocking loadSecUserBlocking(IamUserContext userContext, String secUserBlockingId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SecUserBlocking searchSecUserBlocking(IamUserContext userContext, String secUserBlockingId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SecUserBlocking present(IamUserContext userContext, SecUserBlocking secUserBlocking, Map<String, Object> tokens) throws Exception {
 	...
 	public SecUserBlocking loadSecUserBlockingDetail(IamUserContext userContext, String secUserBlockingId) throws Exception{	
 	...
 	public Object view(IamUserContext userContext, String secUserBlockingId) throws Exception{	
 		SecUserBlocking secUserBlocking = loadSecUserBlocking( userContext, secUserBlockingId, viewTokens());
 		return present(userContext,secUserBlocking, allTokens());
		
 	}
 	protected SecUserBlocking saveSecUserBlocking(IamUserContext userContext, SecUserBlocking secUserBlocking, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getSecUserBlockingDAO().save(secUserBlocking, tokens);
 	}
 	protected SecUserBlocking loadSecUserBlocking(IamUserContext userContext, String secUserBlockingId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfSecUserBlocking(secUserBlockingId);
		userContext.getChecker().throwExceptionIfHasErrors( SecUserBlockingManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(IamUserContext userContext, SecUserBlocking secUserBlocking, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(IamUserContext userContext, SecUserBlocking secUserBlocking, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSecUserBlocking(IamUserContext userContext,String secUserBlockingId, int secUserBlockingVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SecUserBlocking clone(IamUserContext userContext, String fromSecUserBlockingId) throws Exception{
	...
	public SecUserBlocking internalSaveSecUserBlocking(IamUserContext userContext, SecUserBlocking secUserBlocking, Map<String,Object> options) throws Exception 
	{
	...
	public SecUserBlocking updateSecUserBlockingProperty(IamUserContext userContext,String secUserBlockingId, int secUserBlockingVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingSecUserBlocking(userContext, secUserBlockingId, secUserBlockingVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(IamUserContext userContext, String secUserBlockingId, int secUserBlockingVersion) throws Exception {
	...
	public SecUserBlocking forgetByAll(IamUserContext userContext, String secUserBlockingId, int secUserBlockingVersion) throws Exception {
		return forgetByAllInternal(userContext, secUserBlockingId, secUserBlockingVersion);		
	}
	protected SecUserBlocking forgetByAllInternal(IamUserContext userContext,
			String secUserBlockingId, int secUserBlockingVersion) throws Exception{
	...
	protected SecUserBlocking breakWithSecUserByDomain(IamUserContext userContext, String secUserBlockingId, String domainId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingSecUser(IamUserContext userContext, String secUserBlockingId, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime, String domainId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUserProperties(IamUserContext userContext, String secUserBlockingId,String id,String login,String mobile,String email,String pwd,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime,String [] tokensExpr) throws Exception {
	...
	public  SecUserBlocking updateSecUserProperties(IamUserContext userContext, String secUserBlockingId, String id,String login,String mobile,String email,String pwd,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime, String [] tokensExpr) throws Exception
	{	
	...
	protected SecUser createSecUser(IamUserContext userContext, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime, String domainId) throws Exception{
	...
	protected void checkParamsForRemovingSecUserList(IamUserContext userContext, String secUserBlockingId, 
	...
	public  SecUserBlocking removeSecUserList(IamUserContext userContext, String secUserBlockingId, 
			String secUserIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSecUser(IamUserContext userContext, String secUserBlockingId, 
	...
	public  SecUserBlocking removeSecUser(IamUserContext userContext, String secUserBlockingId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSecUser(IamUserContext userContext, String secUserBlockingId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUserBlocking copySecUserFrom(IamUserContext userContext, String secUserBlockingId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUser(IamUserContext userContext, String secUserBlockingId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUserBlocking updateSecUser(IamUserContext userContext, String secUserBlockingId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
