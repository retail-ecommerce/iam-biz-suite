...
public class SecUserBlockingJDBCTemplateDAO extends IamNamingServiceDAO implements SecUserBlockingDAO{
	...
	*/
    ...
    public SmartList<SecUserBlocking> requestCandidateSecUserBlockingForSecUser(IamUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
