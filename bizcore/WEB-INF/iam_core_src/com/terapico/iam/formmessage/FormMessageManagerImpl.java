...
public class FormMessageManagerImpl extends CustomIamCheckerManager implements FormMessageManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormMessageManagerException{
 	...
 	protected FormMessage saveFormMessage(IamUserContext userContext, FormMessage formMessage, String [] tokensExpr) throws Exception{	
 	...
 	protected FormMessage saveFormMessageDetail(IamUserContext userContext, FormMessage formMessage) throws Exception{	
 	...
 	public FormMessage loadFormMessage(IamUserContext userContext, String formMessageId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormMessage searchFormMessage(IamUserContext userContext, String formMessageId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormMessage present(IamUserContext userContext, FormMessage formMessage, Map<String, Object> tokens) throws Exception {
 	...
 	public FormMessage loadFormMessageDetail(IamUserContext userContext, String formMessageId) throws Exception{	
 	...
 	public Object view(IamUserContext userContext, String formMessageId) throws Exception{	
 		FormMessage formMessage = loadFormMessage( userContext, formMessageId, viewTokens());
 		return present(userContext,formMessage, allTokens());
		
 	}
 	protected FormMessage saveFormMessage(IamUserContext userContext, FormMessage formMessage, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormMessageDAO().save(formMessage, tokens);
 	}
 	protected FormMessage loadFormMessage(IamUserContext userContext, String formMessageId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormMessage(formMessageId);
		userContext.getChecker().throwExceptionIfHasErrors( FormMessageManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(IamUserContext userContext, FormMessage formMessage, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(IamUserContext userContext, FormMessage formMessage, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormMessage(IamUserContext userContext,String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormMessage clone(IamUserContext userContext, String fromFormMessageId) throws Exception{
	...
	public FormMessage internalSaveFormMessage(IamUserContext userContext, FormMessage formMessage, Map<String,Object> options) throws Exception 
	{
	...
	public FormMessage updateFormMessageProperty(IamUserContext userContext,String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormMessage(userContext, formMessageId, formMessageVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(IamUserContext userContext, String formMessageId, String anotherFormId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(IamUserContext userContext, String formMessageId, int formMessageVersion) throws Exception {
	...
	public FormMessage forgetByAll(IamUserContext userContext, String formMessageId, int formMessageVersion) throws Exception {
		return forgetByAllInternal(userContext, formMessageId, formMessageVersion);		
	}
	protected FormMessage forgetByAllInternal(IamUserContext userContext,
			String formMessageId, int formMessageVersion) throws Exception{
