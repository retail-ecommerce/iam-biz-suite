...
public class UserDomainManagerImpl extends CustomIamCheckerManager implements UserDomainManager {
	...
	protected void throwExceptionWithMessage(String value) throws UserDomainManagerException{
 	...
 	protected UserDomain saveUserDomain(IamUserContext userContext, UserDomain userDomain, String [] tokensExpr) throws Exception{	
 	...
 	protected UserDomain saveUserDomainDetail(IamUserContext userContext, UserDomain userDomain) throws Exception{	
 	...
 	public UserDomain loadUserDomain(IamUserContext userContext, String userDomainId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UserDomain searchUserDomain(IamUserContext userContext, String userDomainId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UserDomain present(IamUserContext userContext, UserDomain userDomain, Map<String, Object> tokens) throws Exception {
 	...
 	public UserDomain loadUserDomainDetail(IamUserContext userContext, String userDomainId) throws Exception{	
 		UserDomain userDomain = loadUserDomain( userContext, userDomainId, allTokens());
 		return present(userContext,userDomain, allTokens());
		
 	}
 	
 	public Object view(IamUserContext userContext, String userDomainId) throws Exception{	
 		UserDomain userDomain = loadUserDomain( userContext, userDomainId, viewTokens());
 		return present(userContext,userDomain, allTokens());
		
 	}
 	protected UserDomain saveUserDomain(IamUserContext userContext, UserDomain userDomain, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getUserDomainDAO().save(userDomain, tokens);
 	}
 	protected UserDomain loadUserDomain(IamUserContext userContext, String userDomainId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfUserDomain(userDomainId);
		userContext.getChecker().throwExceptionIfHasErrors( UserDomainManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(IamUserContext userContext, UserDomain userDomain, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(IamUserContext userContext, UserDomain userDomain, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUserDomain(IamUserContext userContext,String userDomainId, int userDomainVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UserDomain clone(IamUserContext userContext, String fromUserDomainId) throws Exception{
	...
	public UserDomain internalSaveUserDomain(IamUserContext userContext, UserDomain userDomain, Map<String,Object> options) throws Exception 
	{
	...
	public UserDomain updateUserDomainProperty(IamUserContext userContext,String userDomainId, int userDomainVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingUserDomain(userContext, userDomainId, userDomainVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(IamUserContext userContext, String userDomainId, int userDomainVersion) throws Exception {
	...
	public UserDomain forgetByAll(IamUserContext userContext, String userDomainId, int userDomainVersion) throws Exception {
		return forgetByAllInternal(userContext, userDomainId, userDomainVersion);		
	}
	protected UserDomain forgetByAllInternal(IamUserContext userContext,
			String userDomainId, int userDomainVersion) throws Exception{
	...
	protected void checkParamsForAddingUserWhiteList(IamUserContext userContext, String userDomainId, String userIdentity, String userSpecialFunctions,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserWhiteListProperties(IamUserContext userContext, String userDomainId,String id,String userIdentity,String userSpecialFunctions,String [] tokensExpr) throws Exception {
	...
	public  UserDomain updateUserWhiteListProperties(IamUserContext userContext, String userDomainId, String id,String userIdentity,String userSpecialFunctions, String [] tokensExpr) throws Exception
	{	
	...
	protected UserWhiteList createUserWhiteList(IamUserContext userContext, String userIdentity, String userSpecialFunctions) throws Exception{
	...
	protected void checkParamsForRemovingUserWhiteListList(IamUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeUserWhiteListList(IamUserContext userContext, String userDomainId, 
			String userWhiteListIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingUserWhiteList(IamUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeUserWhiteList(IamUserContext userContext, String userDomainId, 
		String userWhiteListId, int userWhiteListVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingUserWhiteList(IamUserContext userContext, String userDomainId, 
		String userWhiteListId, int userWhiteListVersion,String [] tokensExpr) throws Exception{
	...
	public  UserDomain copyUserWhiteListFrom(IamUserContext userContext, String userDomainId, 
		String userWhiteListId, int userWhiteListVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserWhiteList(IamUserContext userContext, String userDomainId, String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserDomain updateUserWhiteList(IamUserContext userContext, String userDomainId, String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingSecUser(IamUserContext userContext, String userDomainId, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUserProperties(IamUserContext userContext, String userDomainId,String id,String login,String mobile,String email,String pwd,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime,String [] tokensExpr) throws Exception {
	...
	public  UserDomain updateSecUserProperties(IamUserContext userContext, String userDomainId, String id,String login,String mobile,String email,String pwd,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime, String [] tokensExpr) throws Exception
	{	
	...
	protected SecUser createSecUser(IamUserContext userContext, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime) throws Exception{
	...
	protected void checkParamsForRemovingSecUserList(IamUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeSecUserList(IamUserContext userContext, String userDomainId, 
			String secUserIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSecUser(IamUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeSecUser(IamUserContext userContext, String userDomainId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSecUser(IamUserContext userContext, String userDomainId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	public  UserDomain copySecUserFrom(IamUserContext userContext, String userDomainId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUser(IamUserContext userContext, String userDomainId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserDomain updateSecUser(IamUserContext userContext, String userDomainId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
