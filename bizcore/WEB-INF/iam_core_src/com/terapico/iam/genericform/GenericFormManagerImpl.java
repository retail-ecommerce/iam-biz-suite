...
//import com.terapico.iam.BaseManagerImpl;
import com.terapico.iam.IamCheckerManager;
import com.terapico.iam.CustomIamCheckerManager;
...
public class GenericFormManagerImpl extends CustomIamCheckerManager implements GenericFormManager {
	...
	protected void throwExceptionWithMessage(String value) throws GenericFormManagerException{
 	...
 	protected GenericForm saveGenericForm(IamUserContext userContext, GenericForm genericForm, String [] tokensExpr) throws Exception{	
 	...
 	protected GenericForm saveGenericFormDetail(IamUserContext userContext, GenericForm genericForm) throws Exception{	
 	...
 	public GenericForm loadGenericForm(IamUserContext userContext, String genericFormId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public GenericForm searchGenericForm(IamUserContext userContext, String genericFormId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected GenericForm present(IamUserContext userContext, GenericForm genericForm, Map<String, Object> tokens) throws Exception {
 	...
 	public GenericForm loadGenericFormDetail(IamUserContext userContext, String genericFormId) throws Exception{	
 	...
 	public Object view(IamUserContext userContext, String genericFormId) throws Exception{	
 		GenericForm genericForm = loadGenericForm( userContext, genericFormId, viewTokens());
 		return present(userContext,genericForm, allTokens());
		
 	}
 	protected GenericForm saveGenericForm(IamUserContext userContext, GenericForm genericForm, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getGenericFormDAO().save(genericForm, tokens);
 	}
 	protected GenericForm loadGenericForm(IamUserContext userContext, String genericFormId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfGenericForm(genericFormId);
		userContext.getChecker().throwExceptionIfHasErrors( GenericFormManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(IamUserContext userContext, GenericForm genericForm, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(IamUserContext userContext, GenericForm genericForm, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingGenericForm(IamUserContext userContext,String genericFormId, int genericFormVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public GenericForm clone(IamUserContext userContext, String fromGenericFormId) throws Exception{
	...
	public GenericForm internalSaveGenericForm(IamUserContext userContext, GenericForm genericForm, Map<String,Object> options) throws Exception 
	{
	...
	public GenericForm updateGenericFormProperty(IamUserContext userContext,String genericFormId, int genericFormVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingGenericForm(userContext, genericFormId, genericFormVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(IamUserContext userContext, String genericFormId, int genericFormVersion) throws Exception {
		//deleteInternal(userContext, genericFormId, genericFormVersion);		
	}
	protected void deleteInternal(IamUserContext userContext,
	...
	public GenericForm forgetByAll(IamUserContext userContext, String genericFormId, int genericFormVersion) throws Exception {
		return forgetByAllInternal(userContext, genericFormId, genericFormVersion);		
	}
	protected GenericForm forgetByAllInternal(IamUserContext userContext,
			String genericFormId, int genericFormVersion) throws Exception{
	...
	protected int deleteAllInternal(IamUserContext userContext) throws Exception{
	...
	protected void checkParamsForAddingFormMessage(IamUserContext userContext, String genericFormId, String title, String level,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormMessageProperties(IamUserContext userContext, String genericFormId,String id,String title,String level,String [] tokensExpr) throws Exception {
	...
	public  GenericForm updateFormMessageProperties(IamUserContext userContext, String genericFormId, String id,String title,String level, String [] tokensExpr) throws Exception
	{	
	...
	protected FormMessage createFormMessage(IamUserContext userContext, String title, String level) throws Exception{
	...
	protected void checkParamsForRemovingFormMessageList(IamUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormMessageList(IamUserContext userContext, String genericFormId, 
			String formMessageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormMessage(IamUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormMessage(IamUserContext userContext, String genericFormId, 
		String formMessageId, int formMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormMessage(IamUserContext userContext, String genericFormId, 
		String formMessageId, int formMessageVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormMessageFrom(IamUserContext userContext, String genericFormId, 
		String formMessageId, int formMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormMessage(IamUserContext userContext, String genericFormId, String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormMessage(IamUserContext userContext, String genericFormId, String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingFormFieldMessage(IamUserContext userContext, String genericFormId, String title, String parameterName, String level,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormFieldMessageProperties(IamUserContext userContext, String genericFormId,String id,String title,String parameterName,String level,String [] tokensExpr) throws Exception {
	...
	public  GenericForm updateFormFieldMessageProperties(IamUserContext userContext, String genericFormId, String id,String title,String parameterName,String level, String [] tokensExpr) throws Exception
	{	
	...
	protected FormFieldMessage createFormFieldMessage(IamUserContext userContext, String title, String parameterName, String level) throws Exception{
	...
	protected void checkParamsForRemovingFormFieldMessageList(IamUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormFieldMessageList(IamUserContext userContext, String genericFormId, 
			String formFieldMessageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormFieldMessage(IamUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormFieldMessage(IamUserContext userContext, String genericFormId, 
		String formFieldMessageId, int formFieldMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormFieldMessage(IamUserContext userContext, String genericFormId, 
		String formFieldMessageId, int formFieldMessageVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormFieldMessageFrom(IamUserContext userContext, String genericFormId, 
		String formFieldMessageId, int formFieldMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormFieldMessage(IamUserContext userContext, String genericFormId, String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormFieldMessage(IamUserContext userContext, String genericFormId, String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	public  GenericForm updateFormFieldProperties(IamUserContext userContext, String genericFormId, String id,String label,String localeKey,String parameterName,String type,String placeholder,String defaultValue,String description,String fieldGroup,String minimumValue,String maximumValue,boolean required,boolean disabled,boolean customRendering,String candidateValues,String suggestValues, String [] tokensExpr) throws Exception
	{	
	...
	protected FormField createFormField(IamUserContext userContext, String label, String localeKey, String parameterName, String type, String placeholder, String defaultValue, String description, String fieldGroup, String minimumValue, String maximumValue, boolean required, boolean disabled, boolean customRendering, String candidateValues, String suggestValues) throws Exception{
	...
	protected void checkParamsForRemovingFormFieldList(IamUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormFieldList(IamUserContext userContext, String genericFormId, 
			String formFieldIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormField(IamUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormField(IamUserContext userContext, String genericFormId, 
		String formFieldId, int formFieldVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormField(IamUserContext userContext, String genericFormId, 
		String formFieldId, int formFieldVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormFieldFrom(IamUserContext userContext, String genericFormId, 
		String formFieldId, int formFieldVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormField(IamUserContext userContext, String genericFormId, String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormField(IamUserContext userContext, String genericFormId, String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingFormAction(IamUserContext userContext, String genericFormId, String label, String localeKey, String actionKey, String level, String url,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormActionProperties(IamUserContext userContext, String genericFormId,String id,String label,String localeKey,String actionKey,String level,String url,String [] tokensExpr) throws Exception {
	...
	public  GenericForm updateFormActionProperties(IamUserContext userContext, String genericFormId, String id,String label,String localeKey,String actionKey,String level,String url, String [] tokensExpr) throws Exception
	{	
	...
	protected FormAction createFormAction(IamUserContext userContext, String label, String localeKey, String actionKey, String level, String url) throws Exception{
	...
	protected void checkParamsForRemovingFormActionList(IamUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormActionList(IamUserContext userContext, String genericFormId, 
			String formActionIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormAction(IamUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormAction(IamUserContext userContext, String genericFormId, 
		String formActionId, int formActionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormAction(IamUserContext userContext, String genericFormId, 
		String formActionId, int formActionVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormActionFrom(IamUserContext userContext, String genericFormId, 
		String formActionId, int formActionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormAction(IamUserContext userContext, String genericFormId, String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormAction(IamUserContext userContext, String genericFormId, String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
