...
import com.terapico.iam.userapp.CandidateUserApp;
...
public class ObjectAccessManagerImpl extends CustomIamCheckerManager implements ObjectAccessManager {
	...
	protected void throwExceptionWithMessage(String value) throws ObjectAccessManagerException{
 	...
 	protected ObjectAccess saveObjectAccess(IamUserContext userContext, ObjectAccess objectAccess, String [] tokensExpr) throws Exception{	
 	...
 	protected ObjectAccess saveObjectAccessDetail(IamUserContext userContext, ObjectAccess objectAccess) throws Exception{	

 		
 		return saveObjectAccess(userContext, objectAccess, allTokens());
 	}
 	
 	public ObjectAccess loadObjectAccess(IamUserContext userContext, String objectAccessId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ObjectAccess searchObjectAccess(IamUserContext userContext, String objectAccessId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ObjectAccess present(IamUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens) throws Exception {
 	...
 	public ObjectAccess loadObjectAccessDetail(IamUserContext userContext, String objectAccessId) throws Exception{	
 	...
 	public Object view(IamUserContext userContext, String objectAccessId) throws Exception{	
 		ObjectAccess objectAccess = loadObjectAccess( userContext, objectAccessId, viewTokens());
 		return present(userContext,objectAccess, allTokens());
		
 	}
 	protected ObjectAccess saveObjectAccess(IamUserContext userContext, ObjectAccess objectAccess, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getObjectAccessDAO().save(objectAccess, tokens);
 	}
 	protected ObjectAccess loadObjectAccess(IamUserContext userContext, String objectAccessId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfObjectAccess(objectAccessId);
		userContext.getChecker().throwExceptionIfHasErrors( ObjectAccessManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(IamUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(IamUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens){
	...
	public ObjectAccess createObjectAccess(IamUserContext userContext,String name, String objectType, String list1, String list2, String list3, String list4, String list5, String list6, String list7, String list8, String list9, String appId) throws Exception
	{
	...
	protected void checkParamsForUpdatingObjectAccess(IamUserContext userContext,String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ObjectAccess clone(IamUserContext userContext, String fromObjectAccessId) throws Exception{
		
		return userContext.getDAOGroup().getObjectAccessDAO().clone(fromObjectAccessId, this.allTokens());
	}
	
	public ObjectAccess internalSaveObjectAccess(IamUserContext userContext, ObjectAccess objectAccess) throws Exception 
	{
		return internalSaveObjectAccess(userContext, objectAccess, allTokens());

	}
	public ObjectAccess internalSaveObjectAccess(IamUserContext userContext, ObjectAccess objectAccess, Map<String,Object> options) throws Exception 
	{
	...
	public ObjectAccess updateObjectAccess(IamUserContext userContext,String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingObjectAccess(userContext, objectAccessId, objectAccessVersion, property, newValueExpr, tokensExpr);
	...
	public ObjectAccess updateObjectAccessProperty(IamUserContext userContext,String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingObjectAccess(userContext, objectAccessId, objectAccessVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherApp(IamUserContext userContext, String objectAccessId, String anotherAppId) throws Exception
 	{
 	...
 	public ObjectAccess transferToAnotherApp(IamUserContext userContext, String objectAccessId, String anotherAppId) throws Exception
 	{
	...
	public CandidateUserApp requestCandidateApp(IamUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected UserApp loadUserApp(IamUserContext userContext, String newAppId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(IamUserContext userContext, String objectAccessId, int objectAccessVersion) throws Exception {
	...
	public ObjectAccess forgetByAll(IamUserContext userContext, String objectAccessId, int objectAccessVersion) throws Exception {
		return forgetByAllInternal(userContext, objectAccessId, objectAccessVersion);		
	}
	protected ObjectAccess forgetByAllInternal(IamUserContext userContext,
			String objectAccessId, int objectAccessVersion) throws Exception{
	...
	public void onNewInstanceCreated(IamUserContext userContext, ObjectAccess newCreated) throws Exception{
