...
@JsonSerialize(using = IamExceptionJsonSerializer.class)
public class IamException extends Exception implements MessageContainer {
    ...
    public IamException(Message message) {
    	super();
        this.addErrorMessage(message);
    }
	public IamException(List<Message> messageList) {
        super();
