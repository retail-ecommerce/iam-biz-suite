...
public class UserWhiteListManagerImpl extends CustomIamCheckerManager implements UserWhiteListManager {
	...
	protected void throwExceptionWithMessage(String value) throws UserWhiteListManagerException{
 	...
 	protected UserWhiteList saveUserWhiteList(IamUserContext userContext, UserWhiteList userWhiteList, String [] tokensExpr) throws Exception{	
 	...
 	protected UserWhiteList saveUserWhiteListDetail(IamUserContext userContext, UserWhiteList userWhiteList) throws Exception{	
 	...
 	public UserWhiteList loadUserWhiteList(IamUserContext userContext, String userWhiteListId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UserWhiteList searchUserWhiteList(IamUserContext userContext, String userWhiteListId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UserWhiteList present(IamUserContext userContext, UserWhiteList userWhiteList, Map<String, Object> tokens) throws Exception {
 	...
 	public UserWhiteList loadUserWhiteListDetail(IamUserContext userContext, String userWhiteListId) throws Exception{	
 	...
 	public Object view(IamUserContext userContext, String userWhiteListId) throws Exception{	
 		UserWhiteList userWhiteList = loadUserWhiteList( userContext, userWhiteListId, viewTokens());
 		return present(userContext,userWhiteList, allTokens());
		
 	}
 	protected UserWhiteList saveUserWhiteList(IamUserContext userContext, UserWhiteList userWhiteList, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getUserWhiteListDAO().save(userWhiteList, tokens);
 	}
 	protected UserWhiteList loadUserWhiteList(IamUserContext userContext, String userWhiteListId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfUserWhiteList(userWhiteListId);
		userContext.getChecker().throwExceptionIfHasErrors( UserWhiteListManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(IamUserContext userContext, UserWhiteList userWhiteList, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(IamUserContext userContext, UserWhiteList userWhiteList, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUserWhiteList(IamUserContext userContext,String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UserWhiteList clone(IamUserContext userContext, String fromUserWhiteListId) throws Exception{
	...
	public UserWhiteList internalSaveUserWhiteList(IamUserContext userContext, UserWhiteList userWhiteList, Map<String,Object> options) throws Exception 
	{
	...
	public UserWhiteList updateUserWhiteListProperty(IamUserContext userContext,String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingUserWhiteList(userContext, userWhiteListId, userWhiteListVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherDomain(IamUserContext userContext, String userWhiteListId, String anotherDomainId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(IamUserContext userContext, String userWhiteListId, int userWhiteListVersion) throws Exception {
	...
	public UserWhiteList forgetByAll(IamUserContext userContext, String userWhiteListId, int userWhiteListVersion) throws Exception {
		return forgetByAllInternal(userContext, userWhiteListId, userWhiteListVersion);		
	}
	protected UserWhiteList forgetByAllInternal(IamUserContext userContext,
			String userWhiteListId, int userWhiteListVersion) throws Exception{
