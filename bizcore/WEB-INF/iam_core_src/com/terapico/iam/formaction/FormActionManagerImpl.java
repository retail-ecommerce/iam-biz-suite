...
public class FormActionManagerImpl extends CustomIamCheckerManager implements FormActionManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormActionManagerException{
 	...
 	protected FormAction saveFormAction(IamUserContext userContext, FormAction formAction, String [] tokensExpr) throws Exception{	
 	...
 	protected FormAction saveFormActionDetail(IamUserContext userContext, FormAction formAction) throws Exception{	
 	...
 	public FormAction loadFormAction(IamUserContext userContext, String formActionId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormAction searchFormAction(IamUserContext userContext, String formActionId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormAction present(IamUserContext userContext, FormAction formAction, Map<String, Object> tokens) throws Exception {
 	...
 	public FormAction loadFormActionDetail(IamUserContext userContext, String formActionId) throws Exception{	
 		FormAction formAction = loadFormAction( userContext, formActionId, allTokens());
 		return present(userContext,formAction, allTokens());
		
 	}
 	
 	public Object view(IamUserContext userContext, String formActionId) throws Exception{	
 		FormAction formAction = loadFormAction( userContext, formActionId, viewTokens());
 		return present(userContext,formAction, allTokens());
		
 	}
 	protected FormAction saveFormAction(IamUserContext userContext, FormAction formAction, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormActionDAO().save(formAction, tokens);
 	}
 	protected FormAction loadFormAction(IamUserContext userContext, String formActionId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormAction(formActionId);
		userContext.getChecker().throwExceptionIfHasErrors( FormActionManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(IamUserContext userContext, FormAction formAction, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(IamUserContext userContext, FormAction formAction, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormAction(IamUserContext userContext,String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormAction clone(IamUserContext userContext, String fromFormActionId) throws Exception{
	...
	public FormAction internalSaveFormAction(IamUserContext userContext, FormAction formAction, Map<String,Object> options) throws Exception 
	{
	...
	public FormAction updateFormActionProperty(IamUserContext userContext,String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormAction(userContext, formActionId, formActionVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(IamUserContext userContext, String formActionId, String anotherFormId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(IamUserContext userContext, String formActionId, int formActionVersion) throws Exception {
	...
	public FormAction forgetByAll(IamUserContext userContext, String formActionId, int formActionVersion) throws Exception {
		return forgetByAllInternal(userContext, formActionId, formActionVersion);		
	}
	protected FormAction forgetByAllInternal(IamUserContext userContext,
			String formActionId, int formActionVersion) throws Exception{
