...
public class IamChecker extends BaseChecker{
	...
	public void setUserContext(IamUserContext userContext) {
	...
	public IamChecker checkIdOfUserDomain(String id)
	{
	...
	public IamChecker checkNameOfUserDomain(String name)
	{
	...
	public IamChecker checkVersionOfUserDomain(int version)
	{
	...
	public IamChecker checkIdOfUserWhiteList(String id)
	{
	...
	public IamChecker checkUserIdentityOfUserWhiteList(String userIdentity)
	{
	...
	public IamChecker checkUserSpecialFunctionsOfUserWhiteList(String userSpecialFunctions)
	{
	...
	public IamChecker checkDomainIdOfUserWhiteList(String domainId)
	{
	...
	public IamChecker checkVersionOfUserWhiteList(int version)
	{
	...
	public IamChecker checkIdOfSecUser(String id)
	{
	...
	public IamChecker checkLoginOfSecUser(String login)
	{
	...
	public IamChecker checkMobileOfSecUser(String mobile)
	{
	...
	public IamChecker checkEmailOfSecUser(String email)
	{
	...
	public IamChecker checkPwdOfSecUser(String pwd)
	{
	...
	public IamChecker checkVerificationCodeOfSecUser(int verificationCode)
	{
	...
	public IamChecker checkVerificationCodeExpireOfSecUser(DateTime verificationCodeExpire)
	{
	...
	public IamChecker checkLastLoginTimeOfSecUser(DateTime lastLoginTime)
	{
	...
	public IamChecker checkDomainIdOfSecUser(String domainId)
	{
	...
	public IamChecker checkVersionOfSecUser(int version)
	{
	...
	public IamChecker checkIdOfSecUserBlocking(String id)
	{
	...
	public IamChecker checkWhoOfSecUserBlocking(String who)
	{
	...
	public IamChecker checkCommentsOfSecUserBlocking(String comments)
	{
	...
	public IamChecker checkVersionOfSecUserBlocking(int version)
	{
	...
	public IamChecker checkIdOfUserApp(String id)
	{
	...
	public IamChecker checkTitleOfUserApp(String title)
	{
	...
	public IamChecker checkSecUserIdOfUserApp(String secUserId)
	{
	...
	public IamChecker checkAppIconOfUserApp(String appIcon)
	{
	...
	public IamChecker checkFullAccessOfUserApp(boolean fullAccess)
	{
	...
	public IamChecker checkPermissionOfUserApp(String permission)
	{
	...
	public IamChecker checkObjectTypeOfUserApp(String objectType)
	{
	...
	public IamChecker checkObjectIdOfUserApp(String objectId)
	{
	...
	public IamChecker checkLocationOfUserApp(String location)
	{
	...
	public IamChecker checkVersionOfUserApp(int version)
	{
	...
	public IamChecker checkIdOfListAccess(String id)
	{
	...
	public IamChecker checkNameOfListAccess(String name)
	{
	...
	public IamChecker checkInternalNameOfListAccess(String internalName)
	{
	...
	public IamChecker checkReadPermissionOfListAccess(boolean readPermission)
	{
	...
	public IamChecker checkCreatePermissionOfListAccess(boolean createPermission)
	{
	...
	public IamChecker checkDeletePermissionOfListAccess(boolean deletePermission)
	{
	...
	public IamChecker checkUpdatePermissionOfListAccess(boolean updatePermission)
	{
	...
	public IamChecker checkExecutionPermissionOfListAccess(boolean executionPermission)
	{
	...
	public IamChecker checkAppIdOfListAccess(String appId)
	{
	...
	public IamChecker checkVersionOfListAccess(int version)
	{
	...
	public IamChecker checkIdOfObjectAccess(String id)
	{
	...
	public IamChecker checkNameOfObjectAccess(String name)
	{
	...
	public IamChecker checkObjectTypeOfObjectAccess(String objectType)
	{
	...
	public IamChecker checkList1OfObjectAccess(String list1)
	{
	...
	public IamChecker checkList2OfObjectAccess(String list2)
	{
	...
	public IamChecker checkList3OfObjectAccess(String list3)
	{
	...
	public IamChecker checkList4OfObjectAccess(String list4)
	{
	...
	public IamChecker checkList5OfObjectAccess(String list5)
	{
	...
	public IamChecker checkList6OfObjectAccess(String list6)
	{
	...
	public IamChecker checkList7OfObjectAccess(String list7)
	{
	...
	public IamChecker checkList8OfObjectAccess(String list8)
	{
	...
	public IamChecker checkList9OfObjectAccess(String list9)
	{
	...
	public IamChecker checkAppIdOfObjectAccess(String appId)
	{
	...
	public IamChecker checkVersionOfObjectAccess(int version)
	{
	...
	public IamChecker checkIdOfLoginHistory(String id)
	{
	...
	public IamChecker checkFromIpOfLoginHistory(String fromIp)
	{
	...
	public IamChecker checkDescriptionOfLoginHistory(String description)
	{
	...
	public IamChecker checkSecUserIdOfLoginHistory(String secUserId)
	{
	...
	public IamChecker checkVersionOfLoginHistory(int version)
	{
	...
	public IamChecker checkIdOfGenericForm(String id)
	{
	...
	public IamChecker checkTitleOfGenericForm(String title)
	{
	...
	public IamChecker checkDescriptionOfGenericForm(String description)
	{
	...
	public IamChecker checkVersionOfGenericForm(int version)
	{
	...
	public IamChecker checkIdOfFormMessage(String id)
	{
	...
	public IamChecker checkTitleOfFormMessage(String title)
	{
	...
	public IamChecker checkFormIdOfFormMessage(String formId)
	{
	...
	public IamChecker checkLevelOfFormMessage(String level)
	{
	...
	public IamChecker checkVersionOfFormMessage(int version)
	{
	...
	public IamChecker checkIdOfFormFieldMessage(String id)
	{
	...
	public IamChecker checkTitleOfFormFieldMessage(String title)
	{
	...
	public IamChecker checkParameterNameOfFormFieldMessage(String parameterName)
	{
	...
	public IamChecker checkFormIdOfFormFieldMessage(String formId)
	{
	...
	public IamChecker checkLevelOfFormFieldMessage(String level)
	{
	...
	public IamChecker checkVersionOfFormFieldMessage(int version)
	{
	...
	public IamChecker checkIdOfFormField(String id)
	{
	...
	public IamChecker checkLabelOfFormField(String label)
	{
	...
	public IamChecker checkLocaleKeyOfFormField(String localeKey)
	{
	...
	public IamChecker checkParameterNameOfFormField(String parameterName)
	{
	...
	public IamChecker checkTypeOfFormField(String type)
	{
	...
	public IamChecker checkFormIdOfFormField(String formId)
	{
	...
	public IamChecker checkPlaceholderOfFormField(String placeholder)
	{
	...
	public IamChecker checkDefaultValueOfFormField(String defaultValue)
	{
	...
	public IamChecker checkDescriptionOfFormField(String description)
	{
	...
	public IamChecker checkFieldGroupOfFormField(String fieldGroup)
	{
	...
	public IamChecker checkMinimumValueOfFormField(String minimumValue)
	{
	...
	public IamChecker checkMaximumValueOfFormField(String maximumValue)
	{
	...
	public IamChecker checkRequiredOfFormField(boolean required)
	{
	...
	public IamChecker checkDisabledOfFormField(boolean disabled)
	{
	...
	public IamChecker checkCustomRenderingOfFormField(boolean customRendering)
	{
	...
	public IamChecker checkCandidateValuesOfFormField(String candidateValues)
	{
	...
	public IamChecker checkSuggestValuesOfFormField(String suggestValues)
	{
	...
	public IamChecker checkVersionOfFormField(int version)
	{
	...
	public IamChecker checkIdOfFormAction(String id)
	{
	...
	public IamChecker checkLabelOfFormAction(String label)
	{
	...
	public IamChecker checkLocaleKeyOfFormAction(String localeKey)
	{
	...
	public IamChecker checkActionKeyOfFormAction(String actionKey)
	{
	...
	public IamChecker checkLevelOfFormAction(String level)
	{
	...
	public IamChecker checkUrlOfFormAction(String url)
	{
	...
	public IamChecker checkFormIdOfFormAction(String formId)
	{
	...
	public IamChecker checkVersionOfFormAction(int version)
	{
