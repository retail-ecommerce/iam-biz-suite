...
import com.terapico.iam.secuser.CandidateSecUser;
...
public class UserAppManagerImpl extends CustomIamCheckerManager implements UserAppManager {
	...
	protected void throwExceptionWithMessage(String value) throws UserAppManagerException{
 	...
 	protected UserApp saveUserApp(IamUserContext userContext, UserApp userApp, String [] tokensExpr) throws Exception{	
 	...
 	protected UserApp saveUserAppDetail(IamUserContext userContext, UserApp userApp) throws Exception{	
 	...
 	public UserApp loadUserApp(IamUserContext userContext, String userAppId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UserApp searchUserApp(IamUserContext userContext, String userAppId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UserApp present(IamUserContext userContext, UserApp userApp, Map<String, Object> tokens) throws Exception {
 	...
 	public UserApp loadUserAppDetail(IamUserContext userContext, String userAppId) throws Exception{	
 		UserApp userApp = loadUserApp( userContext, userAppId, allTokens());
 		return present(userContext,userApp, allTokens());
		
 	}
 	
 	public Object view(IamUserContext userContext, String userAppId) throws Exception{	
 		UserApp userApp = loadUserApp( userContext, userAppId, viewTokens());
 		return present(userContext,userApp, allTokens());
		
 	}
 	protected UserApp saveUserApp(IamUserContext userContext, UserApp userApp, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getUserAppDAO().save(userApp, tokens);
 	}
 	protected UserApp loadUserApp(IamUserContext userContext, String userAppId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfUserApp(userAppId);
		userContext.getChecker().throwExceptionIfHasErrors( UserAppManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(IamUserContext userContext, UserApp userApp, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(IamUserContext userContext, UserApp userApp, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUserApp(IamUserContext userContext,String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UserApp clone(IamUserContext userContext, String fromUserAppId) throws Exception{
	...
	public UserApp internalSaveUserApp(IamUserContext userContext, UserApp userApp, Map<String,Object> options) throws Exception 
	{
	...
	public UserApp updateUserAppProperty(IamUserContext userContext,String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingUserApp(userContext, userAppId, userAppVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(IamUserContext userContext, String userAppId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(IamUserContext userContext, String userAppId, String anotherLogin) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithLogin(IamUserContext userContext, String userAppId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(IamUserContext userContext, String userAppId, String anotherEmail) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithEmail(IamUserContext userContext, String userAppId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(IamUserContext userContext, String userAppId, String anotherMobile) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithMobile(IamUserContext userContext, String userAppId, String anotherMobile) throws Exception
 	{
	...
	public CandidateSecUser requestCandidateSecUser(IamUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected SecUser loadSecUser(IamUserContext userContext, String newSecUserId, Map<String,Object> options) throws Exception
 	{
		
 		return userContext.getDAOGroup().getSecUserDAO().load(newSecUserId, options);
 	}
 	
 	protected SecUser loadSecUserWithLogin(IamUserContext userContext, String newLogin, Map<String,Object> options) throws Exception
 	{
 	...
 	protected SecUser loadSecUserWithEmail(IamUserContext userContext, String newEmail, Map<String,Object> options) throws Exception
 	{
 	...
 	protected SecUser loadSecUserWithMobile(IamUserContext userContext, String newMobile, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(IamUserContext userContext, String userAppId, int userAppVersion) throws Exception {
	...
	public UserApp forgetByAll(IamUserContext userContext, String userAppId, int userAppVersion) throws Exception {
		return forgetByAllInternal(userContext, userAppId, userAppVersion);		
	}
	protected UserApp forgetByAllInternal(IamUserContext userContext,
			String userAppId, int userAppVersion) throws Exception{
	...
	protected void checkParamsForAddingListAccess(IamUserContext userContext, String userAppId, String name, String internalName, boolean readPermission, boolean createPermission, boolean deletePermission, boolean updatePermission, boolean executionPermission,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingListAccessProperties(IamUserContext userContext, String userAppId,String id,String name,String internalName,boolean readPermission,boolean createPermission,boolean deletePermission,boolean updatePermission,boolean executionPermission,String [] tokensExpr) throws Exception {
	...
	public  UserApp updateListAccessProperties(IamUserContext userContext, String userAppId, String id,String name,String internalName,boolean readPermission,boolean createPermission,boolean deletePermission,boolean updatePermission,boolean executionPermission, String [] tokensExpr) throws Exception
	{	
	...
	protected ListAccess createListAccess(IamUserContext userContext, String name, String internalName, boolean readPermission, boolean createPermission, boolean deletePermission, boolean updatePermission, boolean executionPermission) throws Exception{
	...
	protected void checkParamsForRemovingListAccessList(IamUserContext userContext, String userAppId, 
	...
	public  UserApp removeListAccessList(IamUserContext userContext, String userAppId, 
			String listAccessIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingListAccess(IamUserContext userContext, String userAppId, 
	...
	public  UserApp removeListAccess(IamUserContext userContext, String userAppId, 
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingListAccess(IamUserContext userContext, String userAppId, 
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	public  UserApp copyListAccessFrom(IamUserContext userContext, String userAppId, 
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingListAccess(IamUserContext userContext, String userAppId, String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserApp updateListAccess(IamUserContext userContext, String userAppId, String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingObjectAccess(IamUserContext userContext, String userAppId, String name, String objectType, String list1, String list2, String list3, String list4, String list5, String list6, String list7, String list8, String list9,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingObjectAccessProperties(IamUserContext userContext, String userAppId,String id,String name,String objectType,String list1,String list2,String list3,String list4,String list5,String list6,String list7,String list8,String list9,String [] tokensExpr) throws Exception {
	...
	public  UserApp updateObjectAccessProperties(IamUserContext userContext, String userAppId, String id,String name,String objectType,String list1,String list2,String list3,String list4,String list5,String list6,String list7,String list8,String list9, String [] tokensExpr) throws Exception
	{	
	...
	protected ObjectAccess createObjectAccess(IamUserContext userContext, String name, String objectType, String list1, String list2, String list3, String list4, String list5, String list6, String list7, String list8, String list9) throws Exception{
	...
	protected void checkParamsForRemovingObjectAccessList(IamUserContext userContext, String userAppId, 
	...
	public  UserApp removeObjectAccessList(IamUserContext userContext, String userAppId, 
			String objectAccessIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingObjectAccess(IamUserContext userContext, String userAppId, 
	...
	public  UserApp removeObjectAccess(IamUserContext userContext, String userAppId, 
		String objectAccessId, int objectAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingObjectAccess(IamUserContext userContext, String userAppId, 
		String objectAccessId, int objectAccessVersion,String [] tokensExpr) throws Exception{
	...
	public  UserApp copyObjectAccessFrom(IamUserContext userContext, String userAppId, 
		String objectAccessId, int objectAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingObjectAccess(IamUserContext userContext, String userAppId, String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserApp updateObjectAccess(IamUserContext userContext, String userAppId, String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
