...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
    ...
    public Object selectApp(IamUserContext userContext,
    ...
    public SecUser manage(IamUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(IamUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }
    
    public SecUser getCachedSecUser(IamUserContext userContext) {
    ...
    protected Object gotoApp(IamUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(IamUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(IamUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(IamUserContext userContex, int length){
    ...
    protected String getBeanName(IamUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(IamUserContext userContext, UserApp app){
        
        return  app.getObjectId();
        
    }
    protected String getServiceType(IamUserContext userContext, UserApp app){
        
        return app.getObjectType();
    }
    protected String getMethodName(IamUserContext userContext, UserApp app){
    ...
    public Object home(IamUserContext userContext) {
    ...
    public Object loginWithEmail(IamUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"email",email, password);
    
    }
    public Object login(IamUserContext userContext, String email,
            String password) {
    ...
    public Object loginWithLogin(IamUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"login",email, password);
    
    }
    public Object loginWithMobile(IamUserContext userContext, String email,
            String password) {
        return loginInternal(userContext,"mobile",email, password);
    
    }
    protected SecUser loadUserWith(IamUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(IamUserContext userContext, String type, String userId,
            String password) {
     ...
     */
    protected Object loginTheSecUserInternal(IamUserContext userContext, SecUser user, String loginComments) throws Exception {
    ...
    public Object showlogin(IamUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(IamUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        IamUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((IamChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected IamUserContextImpl createNewConext(String path) {

        return new IamUserContextImpl();
    ...
    public Object checkOtherLogin(IamUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(IamUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(IamUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(IamUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(IamUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(IamUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(IamUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
